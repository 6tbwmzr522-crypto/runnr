...
4. **Convert** — Stripe €19/month (or €190/year) when they hit the 5-trade journal cap or want Coach, sync, CSV  
5. **Retain** — Weekly Coach + shareable discipline score  

## Hard no

No auto-DM bots, bought lists, or fake signal bait. Human-reviewed outreach only.

**Safe scout:** `scripts/runnr_reddit_scout.py` — Reddit read-only digest (Markdown). Never posts or DMs. You reply by hand.
...
| 31–60 | Reddit/Discord playbook; short-form templates; upgrade after ~5 trades |
...
| Stage | Target |
|-------|--------|
| Visit → first trade logged | ≥40% |
| Onboarding → aha insight | ≥70% |
| Free → paid | 15–25% |
| Paid → active M3 | >70% |
