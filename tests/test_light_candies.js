...
check("cooldown.js is loaded before pretrade", html.indexOf("js/cooldown.js?v=2") < html.indexOf("js/pretrade.js?v=16"));
...
check("keep-score email CTA still present", html.includes("Keep my score") && html.includes("/login.html?keep=1"));
