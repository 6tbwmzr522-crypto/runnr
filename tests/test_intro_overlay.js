...
check("intro.js cache-busted", html.includes("js/intro.js?v=8"));
...
check("watch skip copy is size a trade", introSrc.includes("Skip to size a trade") && introSrc.includes("WATCH_SKIP_LABEL") && introSrc.includes("playWatchThenSizer"));
...
check("Watch path lands on Sizer not Keep", sandboxSrc.includes("startWatchHow") && sandboxSrc.includes("landWatchOnSizer") && introSrc.includes("playWatchThenSizer"));
