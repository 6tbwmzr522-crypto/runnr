...
appCss.forEach((f) => {
  const pin = f === "css/pages.css" ? "?v=17" : f === "css/layout.css" ? "?v=2" : f === "css/components.css" ? "?v=3" : "?v=1";
...
check("pretrade.css is cache-busted", html.includes("css/pretrade.css?v=10"));
